...
static volatile unsigned char UART1_TxHead = 0;
static volatile unsigned char UART1_TxTail = 0;
static volatile unsigned char UART1_RxHead = 0;
static volatile unsigned char UART1_RxTail = 0;
